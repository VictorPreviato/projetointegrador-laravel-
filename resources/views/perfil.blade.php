...
<main class="profile-cont">
    ...
    <button type="submit" style="display: inline-block; background-color: #ffffff22; color: #fff; padding: 8px 15px; border-radius: 6px; cursor: pointer;" >Enviar foto</button> <!-- botão temporário -->
</form>
