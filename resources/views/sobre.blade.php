...
Acreditamos que cada animal merece um lar onde possa se sentir seguro, amado e respeitado. E também acreditamos que cada pessoa que decide adotar está dando um passo generoso rumo a uma vida mais plena. Por isso, nosso maior objetivo sempre foi criar pontes: conectar corações dispostos a amar com aqueles que mais precisam ser acolhidos.<br>
...
Estamos aqui por eles, e por você também. Juntos, acreditamos que é possível construir um mundo onde todos os animais tenham uma segunda chance e onde o amor encontre sempre um caminho.</div>
        ...
        <div class="caixa-alerta">
            <img src="{{ asset('IMG/ICONES/proibido.webp')}}" class="icone-alerta" alt="Ícone de alerta" style="width: 50px; height: 50px;">
            <p>Nós não trabalhamos com venda de animais. Incentivamos a adoção responsável.</p>
        </div>
 
        <div class="Pets-sobre"  >
        ...
        <section class="secao-parcerias">
            <h1>Parcerias</h1>
            <p>Vamos juntos? Seja uma empresa parceira e transforme o mundo com a gente!</p>
            <h3>Veja quem já está fazendo parte dessa mudança com a gente!</h3>
            <div class="grid-parcerias">
                <div class="item-parceiro"></div>
                <div class="item-parceiro"></div>
                <div class="item-parceiro"></div>
                <div class="item-parceiro"></div>
                <div class="item-parceiro"></div>
